...
<body>
	...
	<div id="main">
		<nav class="navbar navbar-dark bg-primary">
			...
			<span class="text-light font-weight-bold">Add Commodity Price</span>
	...
	<div id=sample>
		...
		<hr/>
		<spring:form action="${pageContext.request.contextPath}/bouser/newCommodityPrice" method="POST" modelAttribute="addcommodityprice">
		<table>
				<tr>
				...
				<tr>
					<td><spring:label path="commodityPrice">Commodity price</spring:label></td>
